...
Config.NpcFiles = {
    { id = 'org-redwire', title = 'منظمة Redwire', threat = 'مرتفع', note = 'شبكة تهريب أسلحة اصطناعية داخل المدينة.' },
    { id = 'cell-blackreef', title = 'خلية Blackreef', threat = 'حرج', note = 'تمويل أنشطة إرهابية واحتمال متفجرات.' },
    { id = 'smug-ironline', title = 'شبكة Ironline', threat = 'متوسط', note = 'خط تهريب أسلحة عبر الميناء.' }
}
